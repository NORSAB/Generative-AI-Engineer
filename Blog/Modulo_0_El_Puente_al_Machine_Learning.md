...
<iframe src="https://norsab.github.io/Generative-AI-Engineer/Blog/figuras/figura3.html?v=11" width="100%" height="160" style="border:none; border-radius:12px; background:#0B0F19; overflow:hidden;" title="Arquitectura RAG (Retrieval-Augmented Generation)"></iframe>
...
<iframe src="https://norsab.github.io/Generative-AI-Engineer/Blog/figuras/figura4.html?v=10" width="100%" height="820" style="border:none; border-radius:12px; background:#0B0F19; overflow:hidden;" title="Evolución de Arquitecturas RAG"></iframe>
